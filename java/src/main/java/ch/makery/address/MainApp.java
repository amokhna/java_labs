...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        ClubData.add(new Club("Леденящие душу приключения Сабрины", "Сезон №1 \"Ужасы\""));
        ClubData.add(new Club("Люцифер", "Сезон №4 \"Драма\""));
        ClubData.add(new Club("Во все тяжкие", "Сезон №5 \"Креминал\""));
        ClubData.add(new Club("Игра престолов", "ЛСезон №4 \"Фэнтези\""));
    }
